...
| Método | Caso de Uso |
| --- | --- |
| [Token de Acesso](/api/autenticacao/token-de-acesso) | Acessar sua própria conta. |
| [Fluxo Authorization Code](/api/autenticacao/authorization-flow) | Permite conseguir permissões para acessar contas de terceiros. |
| [Fluxo Client Credentials](/api/autenticacao/client-credentials-flow) | Permite conseguir um token a partir de uma aplicativo OAuth |
