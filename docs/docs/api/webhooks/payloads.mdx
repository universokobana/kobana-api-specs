...
<TabItem value="json-3" label="payment.tax.* (sub-objeto &quot;tax&quot;; &quot;tax.data&quot; varia por kind: darf/gps/fgts/gru)">
...
<TabItem value="json-1" label="transfer.ted.register.*, transfer.pix.*, transfer.internal.* (envelope de comando)">
