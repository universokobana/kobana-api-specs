...
description: "Módulo Oficial Wordpress/WooCommerce"
---
...
5. Vá até `WooCommerce > Configurações > Produtos > Inventário`;
6. Deixe em branco a opção **Manter estoque (minutos)** (isso evita problemas com contas canceladas antes do cliente pagar o boleto).
7. Salve novamente as configurações;
8. Tudo pronto para receber pagamentos via boleto bancário usando o **Boleto Simples**.
...
![screenshot-1.png](/img/guias/modulos-wordpress-woocommerce/screenshot-1.png)
