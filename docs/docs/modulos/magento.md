---
title: "Magento"
description: "Módulo Oficial Magento v1"
---
...
1. Siga todos os passos das [Pré-configuração do Módulo](https://github.com/BoletoSimples/boletosimples-magento-v1/blob/master/README.md#2-pr%C3%A9-configura%C3%A7%C3%A3o-do-m%C3%B3dulo) antes de prosseguir;
...
![screenshot-1.png](/img/guias/modulos-magento/screenshot-1.png)

![screenshot-2.png](/img/guias/modulos-magento/screenshot-2.png)
