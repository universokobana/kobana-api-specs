...
<TabItem value="json-3" label="payment.tax.* (sub-object &quot;tax&quot;; &quot;tax.data&quot; varies by kind: darf/gps/fgts/gru)">
...
### Boleto Registration (Registration)
...
<TabItem value="json-1" label="transfer.ted.register.*, transfer.pix.*, transfer.internal.* (command envelope)">
