...
| 1010 | Não protestar | Yes | Yes |
| 1018 | Sustar o protesto | Yes | Yes |
...
| 1031 | Alteração de outros dados | Yes | No |
| 1109 | Exclusão de sacador avalista | Yes | No |
| 1112 | Beneficiário não concorda com a alegação do pagador | Yes | No |
...
| 1009 | Protestar | Yes | Yes |
| 1010 | Não protestar | Yes | Yes |
| 1011 | Protesto para fins falimentares | Yes | Yes |
| 1018 | Sustar o protesto | Yes | Yes |
| 1028 | Alterar Valor | Yes | [See table](https://ajuda.kobana.com.br/pt-BR/articles/8843278-posso-alterar-a-data-de-vencimento-e-o-valor-de-um-boleto-ja-emitido) |
| 1031 | Alteração de outros dados | Yes | No |
| 1034 | Pago diretamente ao beneficiário | Yes | Yes |
| 1047 | Não cobrar juros | Yes | Yes |
| 1066 | Entrada em negativação expressa | Yes | Yes |
| 1067 | Não negativar | Yes | Yes |
| 1068 | Excluir negativação expressa | Yes | Yes |
| 1069 | Cancelar negativação expressa | Yes | Yes |

### Collection Instruction Codes

To be sent in the `first_instruction` and `second_instruction` fields of the [Boleto](/api/v1/boletos).

Used only in remittances with CNAB 400 format.
