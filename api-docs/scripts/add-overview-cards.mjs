...
const V2_TAG_GROUPS = {
  ...
  Financeiro: ['Accounts', 'Balances', 'Statement', 'Providers'],
  Transferências: ['Batches', 'Transfers', 'Between Accounts', 'TED', 'Transfer Accounts', 'Pix - Transfer'],
  Pagamentos: ['Bank Billets', 'Payments', 'Payment Accounts', 'DDA Bank Billets', 'DDA Accounts', 'Tax (beta)', 'Utility Bills'],
  Administração: ['Certificate', 'Sub-accounts', 'Connections', 'Commands', 'INTERNAL'],
  Segurança: ['Access Tokens'],
  Mailbox: ['Mailboxes', 'Mailbox Files', 'Email Channel', 'S3 Channel', 'SFTP Channel', 'WhatsApp Channel', 'Syncthing Channel'],
  'Usuários': ['User', 'User Information'],
};
