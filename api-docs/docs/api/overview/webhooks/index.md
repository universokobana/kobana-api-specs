...
| Cabeçalho | Descrição |
| --- | --- |
| **X-Kobana-Event** | [Código do evento](/api/overview/webhooks/events) que gerou essa notificação. |
...
| **X-Kobana-Signature** | [Assinatura de segurança](/api/overview/webhooks/security) , para você verificar que a chamada saiu realmente dos servidores da Kobana. |
| ~~X-BoletoSimples-Event~~ (DEPRECIADO) | [Código do evento](/api/overview/webhooks/events) que gerou essa notificação. |
...
| ~~X-Hub-Signature~~ (DEPRECIADO) | [Assinatura de segurança](/api/overview/webhooks/security) , para você verificar que a chamada saiu realmente dos servidores da Kobana. |
