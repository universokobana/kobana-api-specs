...
| unauthorized | 401 | Token de API inválido. O Token de API é diferente para cada Servidor/URL, mais em [Token de Acesso](/api/overview/authentication/access-token) |
